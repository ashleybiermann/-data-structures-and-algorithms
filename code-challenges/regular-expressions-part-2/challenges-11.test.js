...
const toLastNames = people => {
  return people.map(currentVal => (currentVal.firstName + ' ' + currentVal.lastName));
};
...
------------------------------------------------------------------------------------------------ */
// ^ check from the start of string /d digit {4} quantity of thing before it $ signifies end of string /g global
// this is a test of each pin, based on the regex variable we made
